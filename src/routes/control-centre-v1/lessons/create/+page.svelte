<script lang="ts">
	...
	const createLessonForm = superForm(data.createLessonForm, {
		resetForm: false,
		validators: zod4Client(createLessonSchema),
		dataType: 'json'
	});

	const { form: formData, delayed, enhance } = createLessonForm;
...
<form action="?/createLesson" method="POST" use:enhance>
	<div
	...
	>
		<div class="flex items-center justify-between gap-4">
			...
			<h1 class="text-lg font-semibold md:text-2xl">Нов урок</h1>
		</div>
